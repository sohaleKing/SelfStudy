...
//it returns undefined  nd is not chainable
...
arr2.forEach((elem, index, array) => {
  elem % 2 === 0 && array.splice(index, 1); //that maner only works if there are two even number next to each other
